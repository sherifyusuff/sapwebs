      ...
      <div className="container mx-auto px-4">
        <div className="grid items-center gap-10 md:gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <div className="relative z-10 text-center lg:text-left">
            <div className="animate-fade-in-up mb-4 flex items-center justify-center gap-2 sm:mb-6 lg:justify-start">
              ...
              <span className="ml-2 text-xs font-medium text-[#0a3d62] sm:text-sm">Crafting Digital Excellence</span>
            </div>

            <h1 className="animate-fade-in-up delay-100 mb-4 text-balance text-3xl font-bold leading-tight tracking-tight text-[#0a3d62] sm:mb-6 sm:text-4xl md:text-5xl lg:text-6xl">
              Building Digital Experiences That{" "}
              <span className="bg-gradient-to-r from-[#0a3d62] to-[#87ceeb] bg-clip-text text-transparent">Drive Growth</span>
            </h1>

            <p className="animate-fade-in-up delay-200 mx-auto mb-8 max-w-lg text-pretty text-base text-gray-600 sm:mb-10 sm:text-lg lg:mx-0">
              Sapwebs delivers reliable, scalable, and user-focused web solutions designed to help businesses
              thrive in a digital world.
            </p>

            <div className="animate-fade-in-up delay-300 flex flex-col items-center gap-3 sm:flex-row sm:gap-4 lg:justify-start">
              <Button
                size="lg"
          ...
          {/* Right Images - large & professional */}
          <div className="animate-fade-in-right delay-200 relative mx-auto w-full max-w-md lg:max-w-none">
            <div className="relative grid grid-cols-2 gap-3 sm:gap-5">
              <div className="animate-scale-in delay-300 relative aspect-[3/4] overflow-hidden rounded-xl shadow-2xl shadow-[#87ceeb]/25 ring-2 ring-[#87ceeb]/20 sm:rounded-2xl">
                <Image
              ...
              <div className="animate-scale-in delay-500 relative aspect-[3/4] translate-y-6 overflow-hidden rounded-xl shadow-2xl shadow-[#87ceeb]/25 ring-2 ring-[#87ceeb]/20 sm:translate-y-10 sm:rounded-2xl">
                <Image
            ...
            {/* Decorative sparkle elements - hidden on small mobile */}
            <div className="animate-float absolute -right-2 top-1/4 hidden text-[#87ceeb] sm:block">
              <Sparkle className="h-7 w-7 fill-current sm:h-9 sm:w-9" />
            </div>
            <div className="animate-float delay-300 absolute bottom-1/4 right-1/4 hidden text-[#87ceeb] sm:block">
