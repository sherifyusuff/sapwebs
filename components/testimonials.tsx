  ...
  return (
    <section id="testimonials" ref={sectionRef} className="relative overflow-hidden bg-white py-14 sm:py-20 md:py-28">
      <div className="container mx-auto px-4">
        <div className={`mx-auto mb-10 max-w-2xl text-center sm:mb-16 ${isVisible ? "animate-elastic-in" : "opacity-0"}`}>
        ...
        <div className="grid gap-4 sm:gap-6 md:grid-cols-2 lg:grid-cols-3">
          {testimonials.map((testimonial, index) => (
            <Card
              ...
              className={`border-[#87ceeb]/20 bg-white transition-all duration-500 hover:border-[#87ceeb]/40 hover:shadow-2xl hover:shadow-[#87ceeb]/15 hover:-translate-y-2 ${isVisible ? "animate-float-down" : "opacity-0"}`}
