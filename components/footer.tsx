...
const socialLinks = [
  ...
  { icon: Linkedin, href: "https://linkedin.com/company/sapwebs", label: "LinkedIn", hoverBg: "hover:bg-[#0A66C2]" },
]
  ...
  return (
    <footer className="bg-[#0a3d62]">
      ...
      <div className="border-b border-white/10">
        <div className="container mx-auto px-4 py-8 sm:py-12">
          <div className="flex flex-col items-center gap-4 text-center sm:gap-6 md:flex-row md:justify-between md:text-left">
            <div>
              <h3 className="text-xl font-bold text-white sm:text-2xl">Subscribe to Our Newsletter</h3>
              <p className="mt-1 text-sm text-white/70 sm:mt-2 sm:text-base">Stay updated with our latest news and offers</p>
            </div>
      ...
      <div className="container mx-auto px-4 py-8 sm:py-12">
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-5">
          ...
          <div className="sm:col-span-2">
            ...
            <div className="mt-4 space-y-2 sm:mt-6 sm:space-y-3">
              ...
              <a href="mailto:info@sapwebs.com" className="flex items-center gap-2 text-sm text-white/70 transition-colors hover:text-[#87ceeb] sm:gap-3">
                <Mail className="h-4 w-4 shrink-0" />
                <span>info@sapwebs.com</span>
              </a>
          ...
          {/* Services */}
          <div>
            <h3 className="mb-3 text-sm font-semibold text-white sm:mb-4 sm:text-base">Services</h3>
        ...
        {/* Bottom Bar */}
        <div className="mt-8 flex flex-col items-center gap-4 border-t border-white/10 pt-6 text-center sm:mt-12 sm:pt-8 md:flex-row md:justify-between md:text-left">
